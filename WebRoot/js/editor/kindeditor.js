...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	var arr = [
        ...
        'table td.snn {min-width:40px;max-width:50px;}',
        'table td.ct {min-width:150px;}',
        'table td.tt {min-width:150px;font-weight:bold;background-color:#bdb76b;}',
        'table td {border:1px solid #A4BED4;white-space:normal !important;word-wrap:break-word;word-break:break-all;}',
		'img.ke-flash {',
