...
<head>
    ...
    <script type="text/javascript" src="<%=rootPath%>/dwr/interface/FileRuleAction.js"></script>
    <script type="text/javascript" src="fileRule.js"></script>
</head>
    ...
    <form action="" id="dataForm"  method="post">
        <table cellpadding="0" cellspacing="0" class="table">
            ...
            <tr>
                ...
                <td class="content_td"><input type="text" name="flushBuffer" id="flushBuffer" value="" rows="4" style="width:60%;" />
            </tr>
            <tr>
                <td class="t_td">源文件行列名序列:</td>
                <td class="content_td"><input type="text" name="fileLineFields" id="fileLineFields" value="" rows="4" style="width:60%;" />
                </td>
            </tr>
            <tr>
                <td class="t_td">ROWKEY字段组成:</td>
                <td class="content_td"><input type="text" id="rowKeyFields" name="rowKeyFields" value="" rows="4" style="width:60%;"/>
            </tr>
            <tr>
                <td class="t_td">ROWKEY后缀:</td>
                <td class="content_td"><input type="text" id="rowKeySuffix" name="rowKeySuffix" value="" rows="4" style="width:60%;"/>
            </tr>
            <tr>
                <td   class="t_td">地域表达式:</td>
                <td class="content_td" ><input type="text" id="areaExpr" name="areaExpr" value="" rows="4" style="width:60%;"/>
            </tr>
            <tr>
                <td   class="t_td">备注:</td>
                <td class="content_td"><input type="text" id="remark" name="remark" value="" rows="4" style="width:60%;"/>
            </tr>
            <tr>
                <td   class="t_td">忽略首部行数:</td>
                <td class="content_td"><input type="text" id="skipRows" name="skipRows" value="" rows="4" style="width:60%;"/>
            </tr>
