...
<head>
    ...
    <script type="text/javascript" src="logAnalysis.js"></script>
</head>

<body style='width:100%;height:100%;'>
<div style="width: 100%;height: 100%;overflow: auto;padding-top: 5px;">
<script type="text/javascript" src="<%=rootPath%>/meta/resource/HighCharts/highcharts.js"></script>
<script type="text/javascript" src="<%=rootPath%>/meta/resource/HighCharts/highcharts-more.js"></script>

    <div id="queryFormDIV" class="C_query">
        <table border="0" cellpadding="0" cellspacing="0" style="padding-bottom: 5px;">
            <tr>
            	<td>选择日期:</td>
                <td><input id="dateNo" /></td>
           		<td>&nbsp;&nbsp;业务类型：<select id="job_type"></select> 
	        	</td>
    ...
    <div style="font-weight:bold;margin-top:10px;display:none;" id = "ToolBar1"></div>
    <div id="a1" style="display:none;" name="常规指标">
...
<div style="overflow-y:auto;display:none;" id="dataFormDIV">
    <form action="" id="dataForm"  method="post">
        <table cellpadding="0" cellspacing="0" class="table">
			...
			<tr><td  class = "t_td"><input type="checkbox" checked="checked" id="rule">查询规则详情</td><td colspan="3"  class="content_td">
			<table><tr>
