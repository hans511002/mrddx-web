...
<head>
    ...
    <script type="text/javascript" src="monitorColDetail.js"></script>
	...
	<div>
		<div style="float:left;width: 30%;">
			<table id="collectTable" class="MetaFormTable"  border="0" cellpadding="0" cellspacing="1" >
				...
				<tr><td>文件数量</td><td><span id="FILE_NUM_SP"></span></td><td>文件大小</td><td><span id="FILE_TOTALSIZE_SP"></span></td></tr>
