...
<head>
    ...
    <script type="text/javascript" src="addUpCollect.js"></script>
...
<form action="collectForm" id="collectForm" onsubmit="return false;" style="width:100%;height:100%;">
    <div id="collectDIV" style="position:absolute; padding:1px;height:100%;width:100%;overflow-x:hidden;overflow-y:auto;">
        <table id="collectTable" class="MetaFormTable"  border="0" cellpadding="0" cellspacing="1" >
            ...
            <tr>
            	<th><font color="red">*</font>输入数据源：</th>
            	...
            	<th><font color="red">*</font>文件列表来源类型：</th>
            	<td>
					<select id="INPUT_FILELST_TYPE" style="width: 180px;">
            ...
            <tr>
            	...
            	<th><font color="red">*</font>输入文件处理类型：</th>
            	<td>
					<select id="INPUT_DOTYPE" style="width: 180px;">
        ...
        <table style=" " id="collectTable2" class="MetaFormTable"  border="0" cellpadding="0" cellspacing="1" >
            <tr>
            	<td><font color="red">*</font>输出数据源</td>
            	<td>
            	...
            	<input id="OUTPUT_DATASOURCE_NAME" readonly="readonly" style="width: 300px;" name="OUTPUT_DATASOURCE_NAME" type="text"></input></td>
            	<td><font color="red">*</font>输出文件目录</td>
            	<td><input id="OUTPUT_PATH" style="width: 300px;" name="OUTPUT_PATH" type="text"></input></td>
            	<td>输出文件重命名规则</td>
            	<td><input id="OUTPUT_RENAME_RULE" style="width: 300px;" name="OUTPUT_RENAME_RULE" type="text"></input></td>
            </tr>          

            <tr>
            	<td>输出文件重命名</td>
            	<td><input style="width: 180px" id="OUTPUT_RENAME"></td>
            	<td>输出文件移动目录</td>
            	<td><input id="OUTPUT_MOVE_PATH" style="width: 300px;" name="OUTPUT_MOVE_PATH" type="text"></input></td>
            	<td>压缩类型：</td>
            ...
            <tr>
            	<td>备注</td>
            	<td><input id="NOTE" style="width: 300px;" name="NOTE" type="text"></input></td>
            	<td></td>
            	<td></td>
            	<td></td>
            	<td></td>
        ...
        <div style="height: 20px;width:100%;text-align:center;padding-top: 120px;">
...
<div id="paramDIV" style="left: 0;width:350px;top:50px;position: absolute;display: none;z-index: 100">
</div>
 <div id="div_plugin" style="left: 0;width:532px;height:240;position: absolute;display: none;z-index: 100">
    <div style="margin-bottom: 5px;"><span>请填写插件代码</span><img id="pluginValueExample" src="../../../../meta/resource/images/help.gif" alt="" /><span></span></div>
