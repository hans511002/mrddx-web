...
<html>
<head>
    <title>Reduce详细日志[<%=request.getParameter("reduceTaskId")%>]</title>
    ...
    <script type="text/javascript" src="jobReduceMsgLog.js"></script>
    <style type="text/css">
        html{
            width:100%;
            height:100%;
	...
	<script type="text/javascript">
		var reduceTaskId               ='<%=request.getParameter("reduceTaskId")%>';		
	</script>      
</head>
...
<div id="pageContent" style="position:absolute;top:0px;left:0px;right: 0px;bottom: 0px;overflow: auto;">
    <div  id="queryFormDIV" class="C_query" >
        <ul  style="display: none;">
            <li>Reduce任务Id：<input type="text" value="" class="input" id="reduceTaskId" /></li>
            <li>
