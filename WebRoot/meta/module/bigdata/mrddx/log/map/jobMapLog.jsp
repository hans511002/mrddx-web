...
<html>
<head>
    <title>[MAP日志]<%=request.getParameter("jobName")==null?"":new String(request.getParameter("jobName").getBytes("iso-8859-1"),"UTF-8") %></title>
    ...
    <script type="text/javascript" src="jobMapLog.js"></script>
    <style type="text/css">
        html{
            width:100%;
            height:100%;
