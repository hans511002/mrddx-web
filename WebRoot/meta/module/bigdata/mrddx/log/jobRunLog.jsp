...
<head>
    ...
    <script type="text/javascript" src="jobRunLog.js"></script>
    <style type="text/css">
        html{
            width:100%;
            height:100%;
...
<div id="pageContent" style="position:absolute;top:0px;left:0px;right: 0px;bottom: 0px;overflow: auto;">
    <div  id="queryFormDIV" class="C_query" >
        <ul>
            <li>Job名称：<input type="text" value="" class="input" id="jobName" /></li>
            <li>执行日期：<input type="text" value="" class="input" id="startDate" /><a id='reset1' href="javascript:void(0)">×</a></li>
