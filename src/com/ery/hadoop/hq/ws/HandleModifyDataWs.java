...
public class HandleModifyDataWs implements MetaWsJarQuery {
	...
	public Object executeQuery(StringBuffer logBuffer, Map<String, Object> params, DataAccess access) throws Exception {
		...
		try {
			lst = (List<Map<String, Object>>) MetaWsDataUtil.toObject(bstartKey.toString(), List.class);
		} catch (Exception e) {
		...
		String code = null;
		try {
			resultObj = hbAction.editorHBTableData(htName, lst, sourceId);
		} catch (IOException e) {
